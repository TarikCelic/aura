          ...
          <div className={style.socials}>
            <div className={style.socialLinks}>
              <Link
                onClick={handleNav}
                target="_blank"
                to="https://www.instagram.com/tarikcelicc/"
              >
                <svg
                  fill="#faf9f6"
                  width="25px"
              ...
              <Link
                onClick={handleNav}
                target="_blank"
                to="https://www.facebook.com/tarik.celic.2025"
              >
                <svg
                  fill="#faf9f6"
                  width="25px"
              ...
              <Link
                onClick={handleNav}
                target="_blank"
                to="https://www.linkedin.com/in/tarik-%C4%8Deli%C4%87-303b92363/"
              >
                <svg
                  fill="#faf9f6"
                  width="25px"
              ...
              <Link
                onClick={handleNav}
                target="_blank"
                to="https://github.com/TarikCelic"
              >
                <svg
                  fill="#faf9f6"
                  width="25px"
